...
const WindowManager = {
    ...
    _isTaskbarInteractivePanelOpen() {
        const panelIds = ['start-menu', 'control-center', 'notification-center', 'Surf-panel'];
    ...
    focusWindow(windowId, options = {}) {
        ...
        if (typeof Surf !== 'undefined' && Surf && Surf.isOpen && typeof Surf._ensurePanelForeground === 'function') {
            Surf._ensurePanelForeground();
        }
    },
