...
const SurfData = {
    ...
    commands: {
        ...
        // ===== Surf AI 设置 =====
        SurfSettings: {
            keywords: ['Surf设置', 'Surf ai设置', 'Surf ai 设定', 'Surfai设置', '调整Surf', 'ai设置', 'Surf settings', 'ai settings', 'Surf ai settings'],
            action: 'openSettings:Surf',
            response: { zh: '正在打开 Surf AI 设置... 🤖', en: 'Opening Surf AI settings... 🤖' }
        },
        // ===== 介绍 NyouOS =====
        aboutFluentOS: {
            keywords: ['介绍fluentos', '什么是fluentos', 'fluentos是什么', 'about fluentos', 'what is fluentos', '介绍系统', '关于系统', '介绍nyouos', '什么是nyouos', 'nyouos是什么', 'about nyouos', 'what is nyouos'],
            action: 'none',
            response: { zh: 'NyouOS 是一个基于 Web 技术构建的网页操作系统 💻\n\n✨ 基于 Fluent OS 青山湖 二次开发\n🛠️ 纯 HTML5 + CSS3 + JavaScript 实现\n📱 内置文件管理、浏览器、天气、时钟等系统应用\n🛒 支持通过 App Shop 安装第三方应用\n🤖 集成 Surf AI 智能助手\n🔐 支持 Supabase 账号登录与数据同步\n\n由 KevinAnanda 开发，保留所有权利。', en: 'NyouOS is a web-based operating system 💻\n\n✨ Secondary development based on Fluent OS Qingshan Lake\n🛠️ Pure HTML5 + CSS3 + JavaScript\n📱 Built-in apps: Files, Browser, Weather, Clock, etc.\n🛒 App Shop for third-party apps\n🤖 Surf AI assistant\n🔐 Supabase account login and data sync\n\nDeveloped by KevinAnanda. All rights reserved.' }
        },
        // ===== 亮度 =====
        brightnessUp: {
            keywords: [
        ...
        suggestCustom: {
            ...
            response: {
                zh: [
                    '想让我更聪明？你可以在「设置 → Surf AI」中开启自定义模式，填入你的 API Key，我就能用大语言模型和你对话啦 🧠',
                    '如果你希望更像真人聊天，建议开启自定义模式并接入 API，我的理解能力会明显提升。'
                ],
                en: [
                    'Want me to be smarter? Enable custom mode in Settings → Surf AI with your API Key.',
        ...
        angry: {
            ...
            response: {
                zh: [
                    '别生气嘛 😅 我目前主要通过关键词匹配来回复。\n如果你想让我更智能，可以在「设置 → Surf AI」中开启自定义模式并填入 API Key。',
